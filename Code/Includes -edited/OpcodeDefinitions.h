...
typedef enum TMotorOpTypes
{
	...
	mtrOpResetEncoder,
	mtrOpGetEncoder,
	mtrOpGetEncoderTargetAbsolute,
	mtrOpSetMirroredFlag,
	mtrOpGetMirroredFlag,
  mtrOpSetPositionAndVelocityRelative,
  mtrOpSetPositionAndVelocityAbsolute,
	mtrOpSetVelocity,
	mtrOpGetVelocity,

#if defined(VexIQ) || defined(_WINDOWS)
	mtrOpSetServoPosition,
	mtrOpSetCurrentLimit,
	mtrOpGetCurrentLimit,
	mtrOpGetImmediateCurrent,
	mtrOpRequestPWMScaleUpdate,
	mtrOpGetOverTemp,
	mtrOpGetCurrentLimitFlag,
	mtrOpGetZeroVelocity,
	mtrOpGetZeroPosition,
  mtrOpGetMotorEncoderUnits,
  mtrOpSetMotorEncoderUnits,
#endif

#if defined(bFirmwareStoresMotorDriveSide) || defined(_WINDOWS)
	mtrOpDriveSideList,
	mtrOpGetDriveTrainMoving,
#endif
