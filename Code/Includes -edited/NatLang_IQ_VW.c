...
void displayButtonValues(tIQLCDLine lineNumber = line1, const TPCButton_NL nJoystickValue = Btn0)
{
	...
	{
		case Btn0:	sJoystickTemp = "Btn XX:";
...
void displayControllerValues(tIQLCDLine lineNumber = line1, const TPCJoystick_NL nJoystickValue = JoyX1)
{
	string sOutputString;
	string sJoystickTemp;
...
void armControl(tMotor armMotorPort = motor10, TPCButton_NL upButton = Btn5, TPCButton_NL downButton = Btn7, short armSpeed = 75)
{
