...
task main()
{
	...
	while (true)
	{
		...
		*/
		alpha=(float)abs(joystick.joy1_x1)/abs(maxspeed); // alpha will be left as this if the "if" statement a few lines below is false

		if (abs(joystick.joy1_y1)>dband)
		{
			if (abs(joystick.joy1_x1)>dband+5)// extra so its easier to stay straight5
			{
